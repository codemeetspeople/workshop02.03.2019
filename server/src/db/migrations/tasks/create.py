...
def prepare_models_and_get_alembic_config():
    """Loads all component models to be visible for alembic and creates component specific alembic config.
...
def create(ctx, message='', strict=True):
    """Creates a new revision file for given component."""  # noqa
